...
public class controllerToko {
 ...
 //mengkosongkan isian field     
      public void Reset(){     
          ...
          hm.getCbBarang().setSelectedItem(null);      
 ...
 //menyimpan data    
      public void SimpanData(){      
          ...
          toko.setkategori(hm.getCbBarang().getSelectedItem().toString());    
  ...
  //mengubah data   
      public void Ubah(){     
        ...
        public void isiTable() {     lt =impToko.getAll();
     ...
     public void isiField(int row){   
         ...
         hm.getCbBarang().setSelectedItem(lt.get(row).getkategori().toString());   
     ...
     public void CariKategori(){    
         if (!hm.getCbCari().getSelectedItem().toString().isEmpty()) {
      ...
      private void isiTableCariKategori() {      
          String item = hm.getCbCari().getSelectedItem().toString();
